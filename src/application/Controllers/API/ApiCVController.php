...
class ApiCVController extends App implements IApiController
{
    ...
    public function getAllAction($request, $response, $args){
        ...
        return $response->withJson(CV::get());
    }
    ...
    public function createAction($request, $response, $args){
        ...
        //practic headerul de authentificare o sa fie ceva de genul
        //Bearer <key>
        //deci cu functia explode separ in 2 Bearer de <key> si preiau doar <key> care are
        //index-ul 1
    ...
    public function deleteAction($request, $response, $args){
        ...
        //TODO: TREBUIE IMPLEMENTAT ACTIUNE DE DELETE GLOBALA, REVENIM MAI TARZIU
    }
}