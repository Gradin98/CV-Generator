...
readyFunctionByPageName['index'] = function () {
    ...
    if (key_storage != null) {
        ...
        $('#register_button').attr('onclick', `logoutFunction()`);
...
readyFunctionByPageName['builder/view'] = function () {
    ...
    axios({
        ...
        html += response.data.position != "" ? `<h3>${response.data.position}</h3>` : "";
        ...
        $('#objectiveDetails').append(html);
        $('#printtext #objective').append(html + "<div style='width: 100%; border-bottom: 2px solid #000;'>");
